...
namespace TypeReferences {
	...
	public sealed class ClassExtendsAttribute : ClassTypeConstraintAttribute {
        ...
        public ClassExtendsAttribute(Type baseType, bool allowBaseType = false) {
			BaseType = baseType;
            AllowBaseType = allowBaseType;
        }
        ...
        /// <summary>
        /// Whether the base type is allowed
        /// </summary>
        ...
        public override bool IsConstraintSatisfied(Type type) {
			return base.IsConstraintSatisfied(type)
				&& BaseType.IsAssignableFrom(type) && (AllowBaseType || type != BaseType);
		}
